...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen py-10 px-4">
      ...
      {userProfile && (
        <div className="w-full max-w-4xl bg-background text-foreground shadow-md rounded-lg p-6 mb-6 border">
      ...
      <div className="w-full max-w-4xl bg-background text-foreground shadow-md rounded-lg p-6 border">
      ...
      <Dialog open={isModalOpen} onOpenChange={closeModal} >
        <DialogContent className="max-w-3xl bg-white text-white dark:bg-black dark:text-white"> 
          <DialogHeader>
            <DialogTitle>Email Preview</DialogTitle>
          </DialogHeader>
          {selectedMail?.html ? (
            <div className="overflow-y-auto max-h-[60vh] border rounded-md p-4 bg-muted text-foreground">
