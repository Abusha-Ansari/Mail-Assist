        ...
        <div className="mx-auto w-full flex flex-col space-y-8 sm:space-y-12 max-w-[500px] pt-20">
          ...
          <div className="flex flex-col space-y-6 sm:space-y-8 text-center animate-fade-in">
            ...
            <div className="relative">
              <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight bg-gradient-to-r from-foreground via-primary to-primary/80 bg-clip-text text-transparent relative z-10 animate-slide-in-right">
                Welcome to Custom Mail Templater
              </h1>
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary/10 blur-2xl -z-10 animate-pulse" />
            </div>
            
            <p className="text-lg sm:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-slide-in-right font-medium" style={{animationDelay: '0.3s'}}>
              Create and manage your email templates with 
              <span className="bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent font-bold"> professional ease</span>
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-6 sm:space-y-8 animate-scale-in" style={{animationDelay: '0.6s'}}>
            <Button 
              size="lg" 
              className="group relative w-full h-16 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-500 disabled:opacity-50 bg-primary hover:bg-primary/90 border-0 rounded-2xl overflow-hidden hover:-translate-y-2 hover:scale-[1.02]"
            ...
            >
              ...
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur" />
            </Button>

            <Button
              size="lg"
              variant="outline"
              className="group relative w-full h-16 text-lg font-bold shadow-lg hover:shadow-xl transition-all duration-500 border-2 border-border/50 bg-card/80 backdrop-blur-sm hover:bg-card/90 hover:border-primary/50 rounded-2xl overflow-hidden hover:-translate-y-2 hover:scale-[1.02]"
              onClick={() => router.push('/create-template')}
            >
              <div className="relative flex items-center justify-center gap-4 z-10">
                <Plus className="h-6 w-6 transition-all duration-300 group-hover:scale-110 group-hover:rotate-90 text-foreground group-hover:text-primary" />
                <span className="transition-all duration-300 group-hover:scale-105 text-foreground group-hover:text-primary">
                  Build New Template
                </span>
              </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/30 to-transparent -translate-x-full transition-transform duration-1000 group-hover:translate-x-full opacity-0 group-hover:opacity-100" />
            </Button>
          </div>
          ...
          <div className="text-center animate-fade-in" style={{animationDelay: '0.9s'}}>
            <div className="relative inline-block">
              <p className="text-muted-foreground text-base font-medium bg-card/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-border/50">
